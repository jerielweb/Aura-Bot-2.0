...
export default { name: ["setwarnlimit", "warnlimit"], category: "group", description: "Define el límite de advertencias.", groupOnly: true, adminOnly: true, async run(ctx: any) {
