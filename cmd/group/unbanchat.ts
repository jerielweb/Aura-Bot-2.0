...
export default { name: ["unbanchat", "desbanearchat", "unmutechat"], category: "group", description: "Reactiva las funciones del bot en el chat.", groupOnly: true, adminOnly: true, async run(ctx: any) {
